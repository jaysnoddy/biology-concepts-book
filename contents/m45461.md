...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/divisn_newtcell.png){: data-media-type="image/png"} </span>
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/cell_checkpnts2.png){: data-media-type="image/png"} </span>
...
[1]: https://www.softchalkcloud.com/lesson/serve/wMyJ041TkRlijr/html
