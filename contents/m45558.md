...
![QR Code representing a URL](../resources/food_web.png)
</div>
Head to this [online interactive simulator][1]{: target="_window"} to investigate food web function. In the *Interactive Labs* box, under <u>Food Web</u>, click **Step 1**. Read the instructions first, and then click <strong>Step 2 </strong>for additional instructions. When you are ready to create a simulation, in the upper-right corner of the *Interactive Labs* box, click **OPEN SIMULATOR**.
