...
![ The photo shows a tall structure with a bunker-like door that disappears into a snowbank.](../resources/Figure_21_01_05.jpg "The Svalbard Global Seed Vault is a storage facility for seeds of Earth&#x2019;s diverse crops. (credit: Mari Tefre, Svalbard Global Seed Vault)"){: #fig-ch21_01_05 data-media-type="image/jpg"}
...
<!--<para><link target-id="fig-ch21_01_05" document=""/>The ground is permanently frozen so the seeds will keep, even if the electricity fails.</para>-->
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/decliningfish2.png){: data-media-type="image/png"} </span>
