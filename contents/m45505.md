...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/misconception2.png) </span>
...
2.  [2](#footnote-ref2){: data-type="footnote-ref" name="footnote2"} Pew Research Center for the People &amp; the Press, *Public Praises Science; Scientists Fault Public, Media* (Washington, DC, 2009), 37.
