...
# About OpenStax College   {#eip-723}
...
# About OpenStax College\'s Resources   {#eip-46}
...
## Senior Contributors   {#eip-id8320483}
...
## Faculty Contributors and Reviewers   {#eip-id4438849}
...
{: data-type="newline"}
 ...
 <span data-type="media" id="age-vs-time" data-alt="SimBio screenshot"> ![SimBio screenshot](../resources/SimBio.png){: data-media-type="image/png"} </span>
